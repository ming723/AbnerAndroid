package com.vip.abnerming.tablayout;
	...
	public MaterialTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if(attrs != null) {
            ...
            try {
                ...
                primaryColor = a.getColor(R.styleable.MaterialTabHost_materialTabsPrimaryColor, Color.parseColor("#d43c3c"));
                accentColor = a.getColor(R.styleable.MaterialTabHost_accentColor,Color.parseColor("#ffffff"));
